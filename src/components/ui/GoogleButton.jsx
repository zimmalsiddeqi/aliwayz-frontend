 ...
 * GoogleButton
 *
 * Reusable Google Sign-In button matched to the Aliwayz design system.
 */
const GoogleButton = forwardRef(
  ({ className, isLoading, disabled, onClick, children = 'Continue with Google', ...props }, ref) => {
    return (
      <motion.button
        ref={ref}
        type="button"
        ...
        className={cn(
          ...
          'bg-surface border border-border text-text-primary hover:bg-surface-hover shadow-sm',
